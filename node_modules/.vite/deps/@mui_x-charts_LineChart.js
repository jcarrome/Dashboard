...
import "./chunk-G3IXNCBK.js";
import {
  ownerWindow
} from "./chunk-GG3O7J74.js";
import "./chunk-Q5NGIYPC.js";
import {
...
import "./chunk-AIBDGRKV.js";
import "./chunk-S3Z6QACX.js";
import {
  useThemeProps
} from "./chunk-NK4B7BGE.js";
import "./chunk-ITGWAFDM.js";
import "./chunk-MSEDJWOP.js";
import "./chunk-6BAWQ45C.js";
import {
  _extends,
  clsx_default,
  composeClasses,
  ...
  registerElement(gestureNames, element, options) {
    if (Array.isArray(gestureNames)) {
      gestureNames.forEach((name) => {
        const gestureOptions2 = options?.[name];
  ...
  const allData = React22.useMemo(() => {
    ...
    for (const stackingGroup of stackingGroups) {
      ...
      for (let i = groupIds.length - 1; i >= 0; i -= 1) {
        ...
        const formattedData = xData?.flatMap((x2, index2) => {
  ...
  return (0, import_jsx_runtime14.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime14.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime14.jsxs)("g", {
        ...
        }, slotProps?.axisTick)), tickLabel !== void 0 && showTickLabel && (0, import_jsx_runtime14.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
          text: tickLabel
...
function LineHighlightPlot(props) {
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  const Element2 = slots?.lineHighlight ?? LineHighlightElement;
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(React58.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime35.jsx)(GridLine, {
      y1: start,
      y2: end,
      x1: offset,
      x2: offset,
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime40.jsx)(LoadingOverlay, _extends({}, props.slotProps?.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = props.slots?.noDataOverlay ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime40.jsx)(NoDataOverlay, _extends({}, props.slotProps?.noDataOverlay));
  }
  return null;
}
...
var LineChart = React74.forwardRef(function LineChart2(inProps, ref) {
  ...
  return (0, import_jsx_runtime49.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime49.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime49.jsx)(Toolbar, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime49.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime49.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
